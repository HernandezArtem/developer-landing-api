const I18N = {
  ru: {
    ...
    projects: {
      eyebrow: '/// Проекты',
      title: 'Проекты',
      subtitle: 'Шесть проектов, где я принимал полноценное участие в разработке:',
      ...
      p5title: 'Телемедтест',
      p5text: 'Сайт сервиса дистанционных медицинских осмотров для B2B: презентация продукта, преимущества, кейсы, формы заявок и контентные блоки. Доработка интерфейсов, поддержка страниц и развитие функционала.',
      p6title: 'Альфа выездной сервис',
      p6text: 'Сайт службы автопомощи с акцентом на быстрый вызов, список услуг, контактные сценарии, мессенджеры и понятную подачу преимуществ сервиса 24/7. Доработка интерфейсов, форм и общей логики сайта.',
    },
    contact: {
      eyebrow: '/// Связь',
      title: 'Напишите мне',
    ...
    cookies: {
      text: 'Мы используем cookies, чтобы сайт работал стабильнее. Вы можете принять или отклонить.',
      accept: 'Принять',
      reject: 'Отклонить',
      thanks: 'Спасибо! Настройки сохранены.',
    },
  ...
  en: {
    ...
    projects: {
      eyebrow: '/// Projects',
      title: 'Projects',
      subtitle: 'Six projects where I had a full development role:',
      ...
      p5title: 'Telemedtest',
      p5text: 'Corporate site for a remote medical examination B2B service: product presentation, benefits, cases, request forms and content blocks. UI refinements, page support and feature development.',
      p6title: 'Alpha Help Truck',
      p6text: 'Roadside assistance site focused on quick dispatch, service list, contact flows, messengers and clear 24/7 benefits. UI, forms and site logic refinements.',
    },
    contact: {
      eyebrow: '/// Contact',
      title: 'Write to me',
    ...
    cookies: {
      text: 'We use cookies to keep the site running smoothly. You can accept or decline.',
      accept: 'Accept',
      reject: 'Decline',
      thanks: 'Thanks! Preferences saved.',
    },
    footer: { copy: '© 2026 Artem Hernandez', tagline: 'I love BMW - and only BMW!' },
    heroFirstName: 'Artem',
    heroLastName: 'Hernandez',
    ...
    validation: {
      ...
      consentRequired: 'Please agree to personal data processing',
    },
    errors: {
